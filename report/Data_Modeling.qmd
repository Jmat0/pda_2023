...
We can note that with unbalanced data, our dataset bank seems to better predict the outcome of our dependent variable, with an accuracy of \~75% and a sensitivity of \~87%, compared to 73% accuracy and 86% sensitivity for bank_grouped. 
